                ...
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        ...
                        <ol class="list-inline text-center">
                            ...
                            <li class="list-inline-item active">Student Resources<li>
                        </ol>
                    </div>
                </div>
            </div>  
			...
			<p class="text-center">Please Select Your Class</p>
     		...
     		<div class="p-5">
     		 <div class="m-b10">
						<?php 
					        $class=$_GET['class'];
                            $sql="SELECT DISTINCT(class),subject FROM video WHERE class = '$class'";
                            $query=mysqli_query($con,$sql);
						    while($row=mysqli_fetch_assoc($query))
						    {
								$subject=$row['subject'];
						?>
                             <a href="svideodetail.php?class=<?php echo $class;?>&subject=<?php echo $subject;?>" class="btn btn-outline-primary btn-lg" style="margin:7px;"><?php echo $row['subject'];?></a>
                            <?php }?>

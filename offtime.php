            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Offline Timetable</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                            
                            <li class="list-inline-item">Student Corner /</li>
                            <li class="list-inline-item active">Offline Timetable</li>
                        </ol>
                    </div>
                </div>
            </div>  
     ...
     <div class="container">
			...
			<div class="mt-5 text-center sort-title">
     		...
     		<div class="p-5">
     		    <hr>
			<?php 
				  $sql="SELECT class FROM offlinetime ";
				$query=mysqli_query($con,$sql);
				while($row=mysqli_fetch_assoc($query))
				{
			?>
     		     <a href="offlinetimetable.php?class=<?php echo $row['class'];?>" class="btn btn-outline-info btn-lg" style="margin:5px;"><?php echo $row['class'];?></a>
				<?php } ?>
     		    <hr>
     	        </div>
     </div>

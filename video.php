            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Student Resource</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                            <li class="list-inline-item">Student Corner /</li>
                            <li class="list-inline-item active">Student Resource</li>
...
<section class="">
     <div class="container">
			...
			<p class="text-center">Please Select Your Class</p>
							
     		<div class="p-5">
     		 <div class="m-b10">
						<?php 
					        $class=$_GET['class'];
                            $sql="SELECT DISTINCT(class),subject FROM lecturevideo WHERE class = '$class'";
							$query=mysqli_query($con,$sql);
						    while($row=mysqli_fetch_assoc($query))
						    {
								$subject=$row['subject'];
						?>
                            <a href="videodetail.php?class=<?php echo $class;?>&subject=<?php echo $subject;?>" class="btn btn-outline-primary btn-lg" style="margin:7px;"><?php echo $row['subject'];?></a>
                            <?php }?>

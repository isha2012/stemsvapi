            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Our Gallery</h2>
        ...
        <div class="container">
		 ...
		 <div class="row">
			   ...
			   <div class="card mx-auto mb-2 mt-3">
				  <a href="galleryview.php?id=<?php echo $row['category']; ?>"><img src="admin/img/gallery/<?php echo $row['img'];?>" style="height:250px"></a>
				    <div class="card-body">
					  <h4 class="post-title text-center"><a href="galleryview.php?id=<?php echo $row['category']; ?>"><?php echo $row['category'];?></a></h4>
				    </div>
			   </div>
			  <?php } ?>
		 </div>

            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Fees Details</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                           
                            <li class="list-inline-item">Student Corner /</li>
                             <li class="list-inline-item active">Fees Details</li>
                        </ol>
                    </div>
                </div>
            </div>  
...
<section class="course">
     <div class="container">
     		...
     		<div class="p-5">
     		 <div class="card" >
				 <?php
			   $query=mysqli_query($con,"SELECT * FROM feeinfo");

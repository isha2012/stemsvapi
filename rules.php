...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Rules</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                           <li class="list-inline-item active">Rules</li>
                        </ol>
                    </div>
                </div>
            </div>  
 ...
 <?php 
            	$id=$_GET['id'];
            	$query=mysqli_query($con,"SELECT * FROM rules WHERE ID ='$id'");

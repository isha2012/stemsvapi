            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">House System</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                           
                            <li class="list-inline-item">Academics /</li>
                            <li class="list-inline-item active">House System</li>
                        </ol>
                    </div>
                </div>
            </div>  
     ...
     <div class="container">
			...
			<div class="mt-5 text-center sort-title">
     		...
     		<div class="p-5">
     		 <div class="card" >
				 <?php
			   $query=mysqli_query($con,"SELECT * FROM housesystem");

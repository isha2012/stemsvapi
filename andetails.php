            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Annual Plan</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                            
                            <li class="list-inline-item">Student Resources /</li>
                            <li class="list-inline-item active">Annual Plan</li>
                        </ol>
                    </div>
                </div>
            </div>  
    ...
    <section class="course">
     <div class="container">
			<div class="mt-5 text-center sort-title">
          		<h4><?php $class=$_GET['class']; echo $class. " Annual Plan";?></h4>
     		</div>
     		
     		<div class="p-5">
     		    <hr>
			<?php 
				  $sql="SELECT * FROM pta WHERE class = '$class'";
				$query=mysqli_query($con,$sql);
				while($row=mysqli_fetch_assoc($query))
				{
					$subject=$row['subject'];
			?>
     		     <a href="admin/plan/<?php echo $row['plan'];?>" class="btn btn-outline-info btn-lg" style="margin:5px;"><?php echo $row['subject'];?></a>
				<?php } ?>
     		    <hr>
     	        </div>
     </div>

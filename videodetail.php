            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Video</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                            <li class="list-inline-item">Student Corner /</li>
                            <li class="list-inline-item active">Video</li>
                        </ol>
                    </div>
                </div>
            </div>  
        ...
        <div class="container">
		 ...
		 <div class="row">
		        <?php
					...
					$query=mysqli_query($con,"SELECT * FROM lecturevideo WHERE class='$class' AND subject = '$subject'");

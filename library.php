            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-md-12 mx-auto text-center">
                        <h2 class="font-weight-bold text-uppercase display-4 text-white">Library</h2>
                        <ol class="list-inline text-center">
                            <li class="list-inline-item"><a href="#">Home </a> &nbsp; / </li>
                            
                            <li class="list-inline-item">Student Corner /</li>
                            <li class="list-inline-item active">Library</li>
                        </ol>
                    </div>
                </div>
            </div>  
     		...
     		<div class="p-5">
     		 <div class="card" >
				...
				<div class="acod-content p-3">
											...
											<?php $books=mysqli_query($con,"SELECT SUM(num_book) as Totalbook FROM library ");
											while($book=mysqli_fetch_assoc($books))
											{
											?>
											<h5 class="text-right">Total Nos. of books = <?php echo $book['Totalbook']; ?></h5>
										<?php } ?>
											<div class="table-responsive">
										<table class="table  bordered display" id="example">
							        ...
							        $query=mysqli_query($con,"SELECT * FROM libdesc");
							        while($row=mysqli_fetch_assoc($query))
							        {
							        	 echo $row['details'];
							        }?>
